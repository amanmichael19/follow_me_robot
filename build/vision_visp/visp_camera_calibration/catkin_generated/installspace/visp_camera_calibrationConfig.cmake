...
if(NOT "include;/usr/include/x86_64-linux-gnu;/usr/include/opencv;/usr/include;/usr/include/libxml2;/usr/include/libusb-1.0 " STREQUAL " ")
  set(visp_camera_calibration_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/include/x86_64-linux-gnu;/usr/include/opencv;/usr/include;/usr/include/libxml2;/usr/include/libusb-1.0")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'visp_camera_calibration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amanuel/catkin_ws_proj/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/amanuel/catkin_ws_proj/install/lib;/home/amanuel/catkin_ws_proj/devel/lib;/opt/ros/kinetic/lib)
